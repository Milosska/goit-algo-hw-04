...
# Завдання 2: Сортування відсортованих масивів
...
1. Встановіть репозиторій як вказано в завданні 1 (кроки 1-4)
2. Дотримуйтесь інструкцій у терміналі. Для вибору режиму сортування введіть **_'m'_**
3. Введіть кількість масивів для сортування
4. Введіть числові значення для кожного з вказаних масивів
5. Спостерігайте логування

## Основні моменти реалізації:

1. Рекурсивний підхід
   Алгоритм працює за принципом поділи і володарюй (divide and conquer):

   - Поділяємо список списків на дві частини.
   - Рекурсивно сортуємо ліву та праву частини.
   - Після цього застосовуємо функцію merge для об’єднання двох відсортованих списків.

2. Функція merge

   - Приймає два відсортовані списки.
   - Проходить по обох списках одночасно та по черзі додає менший елемент у новий список.
   - Після завершення основного циклу додає залишки елементів з обох списків.

3. Важливі умови:
   - Вхідні підсписки мають бути відсортовані, інакше результат буде некоректним.
   - У CLI реалізації ми додатково сортуємо підсписки надані користувачем перед рекурсивним об’єднанням.
